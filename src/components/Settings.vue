<template>
  <div class="kura_tm_settings" :class="show ? 'opened' : ''">
    <div class="icon">
      <svg
        ...
        xml:space="preserve"
        class="svg replaced-svg changeDark"
      >
        <g id="Settings">
          <g>
            <path
      ...
      <a class="link" href="#" @click.prevent="show = !show"></a>
    </div>
    <div class="wrapper">
      ...
      <ul class="cursor" id="cursor">
        <li>
          <a
            @click.prevent="cursorFun(1)"
            :class="cursor === 1 ? 'showme show' : 'hide'"
            href="#"
          ></a>
        </li>
        <li>
          <a
            @click.prevent="cursorFun(2)"
            :class="cursor === 2 ? 'showme show' : 'hide'"
            href="#"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              id="Capa_1"
